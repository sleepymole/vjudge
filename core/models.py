...
class Submission(db.Model):
    __tablename__ = "core_submissions"
    ...
    def __repr__(self):
        return (
            f"<Submission(id={self.id}, user_id={self.user_id}, oj_name={self.oj_name}, "
...
class Contest(db.Model):
    ...
    __table_args__ = (
        UniqueConstraint("site", "contest_id", name="_site_contest_id_uc"),
    )
    ...
    def __repr__(self):
        return (
            f'<Contest(site={self.site} contest_id={self.contest_id}, title="{self.title}", '
